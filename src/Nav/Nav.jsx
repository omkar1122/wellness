      ...
      <Container>
        <NavLink to="/" className="col-3 navbar-brand">
          <div className="d-flex align-items-center gap-1">
            <h2 className="logo-text mt-1">H&W</h2>
        ...
        <Navbar.Collapse id="basic-navbar-nav">
          {
            i18n.language === "ar" ?(
            <Nav className="me-auto col-6 d-flex justify-content-between nav-collapse">
            ...
            currentUser ? (
              <div className='d-flex justify-content-center align-items-center gap-2'>
                ...
                <DropDown />
                {
                  i18n.language === "en" && (
                    <>
                      <input type="button" value="Hindi" className="lang-btn lang-ar-btn" onClick={ () => {
                ...
                {
                  i18n.language === "ar" && (<input type="button" value="English" className="lang-btn lang-en-btn" onClick={ () => {
